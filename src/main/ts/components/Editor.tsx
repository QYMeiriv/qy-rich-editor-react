...
export class Editor extends React.Component<IAllProps> {
  ...
  private initialise = (attempts = 0) => {
    ...
    const finalInit: RawEditorSettings = {
      ...
      inline: this.inline,
      plugins: [...mergePlugins(this.props.init?.plugins, this.props.plugins),'toc'],
    ...
    // tinymce.init(Object.assign(finalInit, { plugins: [ ...finalInit.plugins, 'toc' ], toolbar: [ ...finalInit.toolbar, 'toc' ] }));
  };
}
